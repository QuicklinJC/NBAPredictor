...
@bot.tree.command(name="nba_predict", description="Predict next NBA game stats for a player")
async def nba_predict(interaction: discord.Interaction, player_name: str):
    ...
    try:
        ...
        if next_game is None:
            await interaction.followup.send("No upcoming games found for this player.")
            return
